...
//当前相机信息获取
	...
	function doCompass()
	{
		...
		compassContainer.setAttribute('title',' 拖动外环可以旋转视角\n拖动中间的陀螺仪可以自由地旋转\n双击归位(你也可以按住CTRL键并拖动地图来旋转视角)');	
...
/* 			handler.setInputAction(function(movement) {
	...
	function doNavi()
	{
		...
		var naviHTML='    <div class="navigation-controls">\
			<div title="放大" class="navigation-control" onclick="clickZoomIn()">\
				<div class="navigation-control-icon-zoom-in">+</div>\
			</div>\
			<div title="重置视角" class="navigation-control">\
			...
			<div title="缩小" class="navigation-control-last" onclick="clickZoomOut()">\
