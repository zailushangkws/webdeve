 ...
 //将 BingMapsApi.defaultKey对象设置为自己申请的BingApiKey
	 Cesium.BingMapsApi.defaultKey ='Ak20JK-dDvIJY9_Mg7xjTYFakuU-5NDCZDahvwfT5X0Yb020DeAOdAn6ZOwJWf9L';

   //自行定制基础图层选择图标中的内容，并选定一个图层
 ...
 imageryViewModels.push(new Cesium.ProviderViewModel({
            ...
            tooltip : 'The Black Marble: The lights of cities and villages trace the outlines of civilization in this global view of the \
Earth at night as seen by NASA/NOAA\'s Suomi NPP satellite.',
 ...
 imageryViewModels.push(new Cesium.ProviderViewModel({
            name : 'Bing Maps Areial with Labels',
            iconUrl : Cesium.buildModuleUrl('Widgets/Images/ImageryProviders/bingAerialLabels.png'),
            tooltip : 'Bing Maps aerial imagery with label overlays：Bing Maps aerial imagery with label overlays \nhttp://www.bing.com/maps',
            creationFunction : function() {
                return new Cesium.BingMapsImageryProvider({
                    url : '//dev.virtualearth.net',
                     key : 'W3MjBHkPYe6AoMEcdwjU~91eQwGiHbzj2BjHmmba51w~AireS2W_VyEpskRjetiH9S1go6iqFteAOfmWxR7Ab0QQe-NfJCvfDrdFhHwK_dO9',
  ...
  imageryViewModels.push(new Cesium.ProviderViewModel({
            ...
            tooltip : 'Bing Maps standard road maps：Bing Maps standard road maps\nhttp://www.bing.com/maps',
            creationFunction : function() {
                return new Cesium.BingMapsImageryProvider({
                    url : '//dev.virtualearth.net',
                     key : 'W3MjBHkPYe6AoMEcdwjU~91eQwGiHbzj2BjHmmba51w~AireS2W_VyEpskRjetiH9S1go6iqFteAOfmWxR7Ab0QQe-NfJCvfDrdFhHwK_dO9',
...
(new Cesium.Credit('Developed by © Visual Earth Studio, ECNU || Big Data for the Belt and Road © 2015 || Imagery from'));
...
//更改底部图片logo和超链接
/*
$('img[alt="Cesium"]').attr('src','img/ecnulogo1.png').attr('alt','华东师范大学')
	.attr('title','华东师范大学');
$('.cesium-credit-image>a[href="http://cesiumjs.org/"]').attr('href','http://www.ecnu.edu.cn/');
alert($('a[href*="http://www.bing.com"]').attr("tagName"));
*/
...
//viewer.camera.setView({position:Cesium.Cartesian3.fromDegrees(116.4071591969, 39.9046716842,2.2e7)}); 
//设定相机镜头位置,默认为北京
viewer.dataSources.add(Cesium.KmlDataSource.load('./kml/recountry2.kml'));
$(function(){
	//信息框位置
    $("#cesiumContainer").bind("click",function(event){ 
    x=event.clientX;
    y=event.clientY;
    $(".cesium-infoBox").css({position:"fixed",top:y,left:x, width:"28%"});
   // $(".cesium-infoBox-iframe ").css({position:"absolute",top:"26px",left:"-10px", width:"107%"});
...
//图例框的透明度
$('#mylegend ').
	hover(function(){$(this).css('opacity',0.95);},
...
//全局变量 所有国家
var all_name_array=["中国","蒙古","韩国","俄罗斯","印度尼西亚","泰国","马来西亚","越南","新加坡","菲律宾","缅甸","柬埔寨","老挝","文莱",
...
"中非共和国","丹麦","乌干达","乌拉圭","乍得","伊拉克","伯利兹","佛得角","克罗地亚","冈比亚",
...
"沙特阿拉伯伊拉克中立区","法国","法属圭亚那","法属玻利尼西亚","法罗群岛","波多黎哥","波斯尼亚和黑塞哥维那",
...
"马拉维","马提尼克岛","马耳他","马达加斯加","马里"];



var all_lng_array=[105.21,106.920481,127.7669220000,37.619697,106.845599,100.992541,101.975766,108.277199,103.819836,120.984219,
95.956223,104.990963,102.614429,114.727669,125.727539,31.16558,27.953389,43.356892,47.576927,45.038189,
28.369885,78.96288,69.345116,90.356331,79.861243,67.709953,84.124008,73.5361034,90.433601,46.489012,
53.847818,55.923255,53.688046,35.243322,34.851612,30.802498,47.481766,43.679291,51.183884,36.238414,
35.86228,50.5577,48.516388,38.996815,35.233154,19.145136,24.96676,15.472962,19.699024,25.48583,
19.503304,24.079635,23.881275,14.995463,25.013607,15.2,20.168331,21.005859,21.745275,18.4130763,
19.37439,66.923684,64.585262,59.556278,74.766098,71.276093,20.9394440000,9.5017850000,32.2902750000,-55.7658350000,
18.7322070000,43.6792910000,-88.4976500000,-23.6051721000,15.2000000000,-15.3101390000,-19.0208350000,-9.6966450000,-15.1804130000,69.3544626000,
9.5553730000,15.8276590000,17.2283310000,-9.4294990000,-106.346771000,34.3088255000,-1.0231940000,11.6094440000,145.6739000000,135.0000000000,
22.9375060000,24.6848660000,29.8738880000,6.1295830000,-90.2307590000,-78.1834060000,39.7823340000,-77.7811670000,42.5902750000,-74.2973330000,
-83.7534280000,12.3547220000,-62.7829980000,6.6210611000,-89.4387562000,
...
-72.2166667000,-4.5480560000,34.3015250000,-61.0241740000,14.3754160000,46.8691070000,-3.9961660000];



var all_lat_array=[36.18,47.919624,35.9077570000,55.75561,-6.2087634,15.870032,4.210484,14.058324,1.352083,14.599512,
21.913965,12.565679,19.85627,4.535277,-8.874217,48.379433,53.709807,42.315407,40.143105,40.069099,47.411631,
20.593684,30.375321,23.684994,6.927079,33.93911,28.394857,1.977247,27.514162,24.443854,23.424076,21.512583,
32.427908,38.963745,31.046051,26.820553,29.31166,33.223191,25.354826,30.585164,33.854721,26.0667,15.552727,
34.802075,31.952162,51.919438,45.943161,49.817492,48.669026,42.733883,47.162494,56.603189,55.169438,46.151241,
58.595272,45.1,41.153332,44.005859,41.608635,43.8562586,42.708678,48.019573,41.377491,38.969719,41.20438,38.861034,
6.6111110000,56.2639200000,1.3733330000,-32.5227790000,15.4541660000,33.2231910000,
...
9.7489170000,7.3697220000,17.357822,0.2602568000,13.8354794000,43.9423600000,4.8604160000,
...
-13.2543080000,14.6415280000,35.9374960000,-18.7669470000,17.5706920000];
...
//设置时钟
/*总路线不显示
var general_route=Cesium.KmlDataSource.load('./kml/animation_general.kml');
$("#general_route>a").toggle(
				function(){
					viewer.dataSources.removeAll();
					$(this).parent().children()[0].checked=true;
					viewer.dataSources.add(Cesium.KmlDataSource.load('./kml/recountry.kml'));
					document.getElementById('legendbox').src = "img/enroute.jpg";
					document.getElementById('mylegend').style.display = 'block';
                      viewer.dataSources.add(general_route);
...
//var northA_point=new Cesium.KmlDataSource();
 $("input[id='northA_line_checkbox']").click(function(){
                    ...
                    var track_NA_west=northA_west.load('./kml/northA_line_west.kml');//是个promise对象
					var track_NA_east=northA_east.load('./kml/northA_line_east.kml');//是个promise对象
					...
					{ 
                     if( $(".route").not("#northA_line_checkbox").attr("checked")==false){
					document.getElementById('mylegend').style.display = 'none';
                    }
                    (function(){
...
//var northB_point=new Cesium.KmlDataSource();
 $("input[id='northB_line_checkbox']").click(function(){
					...
					document.getElementById('mylegend').style.display = 'block';
		//track the route start
		var track_NB=northB_line.load('./kml/northB_line.kml');//是个promise对象
        ...
        viewer.dataSources.add(track_NB).then(function(dataSource) {//kml加载完之后，设置clockrange，是指针不再前进，只能这样做！！！
					...
					{ 
                    if($(".route").not("#northB_line_checkbox").attr("checked")==false){
					document.getElementById('mylegend').style.display = 'none';
                    }
                    viewer.clock.shouldAnimate = false;
...
//var mid_point=new Cesium.KmlDataSource();
 $("input[id='mid_line_checkbox']").click(function(){
					...
					viewer.clock.shouldAnimate = true;
                    viewer.scene.morphTo2D(0.5);
					var track_mid=mid_line.load('./kml/mid_line.kml');//是个promise对象
...
//var city_center= new Cesium.KmlDataSource();
 $("input[id='center_line_checkbox']").click(function(){
					...
					document.getElementById('legendbox').src = "img/enroute.jpg";
					document.getElementById('mylegend').style.display = 'block';
					var centerline = center_line.load('./kml/center_line.kml',{});
...
//var city_south= new Cesium.KmlDataSource();
 $("input[id='south_line_checkbox']").click(function(){
					...
					document.getElementById('legendbox').src = "img/enroute.jpg";
					document.getElementById('mylegend').style.display = 'block';
                     var track_south2= south_line2.load('./kml/south_line2.kml',{});
					var track_south = south_line.load('./kml/south_line.kml',{});
...
var Relations_china= new Cesium.GeoJsonDataSource();
 $("input[id='Relations_china_radio']").click(function(){
					...
					{
			viewer.clock.shouldAnimate = false;
			 Relations_china.load('./json/Relations_china.geojson',
					{
	...
	viewer.entities.add(Iran_flag);
			//控制图例
			document.getElementById('legendbox').src = "img/enRelations.jpg";
			document.getElementById('mylegend').style.display = 'block';
	...
	viewer.entities.remove(Iran_flag);
            if($(".re").not("#Relations_china_radio").attr("checked")==false){
			    document.getElementById('mylegend').style.display = 'none';
                }
						}
...
var USA= new Cesium.GeoJsonDataSource();
 $("input[id='Relations_usa_radio']").click(function(){
					...
					{
			viewer.clock.shouldAnimate = false;
            USA.load('./json/USA.geojson'
			,{
				stroke: Cesium.Color.GRAY,
				fill: Cesium.Color.MEDIUMORCHID.withAlpha(0.8),
			  });
			 Relations_usa.load('./json/Relations_usa.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Relations_russia= new Cesium.GeoJsonDataSource();
 $("input[id='Relations_russia_radio']").click(function(){
					...
					{
			viewer.clock.shouldAnimate = false;
			 Relations_russia.load('./json/Relations_russia.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var JAPAN= new Cesium.GeoJsonDataSource();
 $("input[id='Relations_japan_radio']").click(function(){
					...
					{
			viewer.clock.shouldAnimate = false;
            JAPAN.load('./json/JAPAN.geojson'
			,{
				stroke: Cesium.Color.GRAY,
				fill: Cesium.Color.GRAY.withAlpha(0.8),
			  });
			 Relations_japan.load('./json/Relations_japan.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var EU= new Cesium.GeoJsonDataSource();
 ...
 $("input[id='Relations_europe_radio']").click(function(){
					...
					{
			viewer.clock.shouldAnimate = false;
             EU.load('./json/EU.geojson'
				,{
				    stroke: Cesium.Color.GRAY,
					fill: Cesium.Color.LIGHTSTEELBLUE.withAlpha(0.8),
				 });
			 Relations_europe.load('./json/Relations_europe.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Relations_india= new Cesium.GeoJsonDataSource();
 $("input[id='Relations_india_radio']").click(function(){
					...
					{
			viewer.clock.shouldAnimate = false;
			 Relations_india.load('./json/Relations_india.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
$("li[id=Nation_status]>a").toggle( 
			 ...
			 promise.then(function(dataSource)
				...
				for(var i=0;i<json_entities.length;i++)
					...
					//控制图例
					document.getElementById('legendbox').src = "img/ennation_status.jpg";
					document.getElementById('mylegend').style.display = 'block';
...
var Nation_stable= new Cesium.GeoJsonDataSource();
 $("input[id='Nation_stable_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Nation_stable.load('./json/Nation_status_stable.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Nation_better= new Cesium.GeoJsonDataSource();
 $("input[id='Nation_better_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Nation_better.load('./json/Nation_status_better.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Nation_issue= new Cesium.GeoJsonDataSource();
 $("input[id='Nation_issue_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Nation_issue.load('./json/Nation_status_issue.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Nation_failure= new Cesium.GeoJsonDataSource();
 $("input[id='Nation_failure_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Nation_failure.load('./json/Nation_status_failure.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
$("li[id=Kotkin_cival]>a").toggle( 
			 ...
			 promise.then(function(dataSource)
				...
				for(var i=0;i<json_entities.length;i++)
					...
					//控制图例
					document.getElementById('legendbox').src = "img/enKTJ.jpg";
					document.getElementById('mylegend').style.display = 'block';
...
var Border_Areas= new Cesium.GeoJsonDataSource();
 $("input[id='Border_Areas_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Border_Areas.load('./json/Kotkin_Border_Areas.geojson',
					{
					 stroke: Cesium.Color.GRAY,
					fill: Cesium.Color.MEDIUMORCHID.withAlpha(0.6),
						});
...
var Middle_Kingdom= new Cesium.GeoJsonDataSource();
 $("input[id='Middle_Kingdom_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Middle_Kingdom.load('./json/Kotkin_Middle_Kingdom.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Olive_Republics= new Cesium.GeoJsonDataSource();
 $("input[id='Olive_Republics_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Olive_Republics.load('./json/Kotkin_Olive_Republics.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Imperial_Russia= new Cesium.GeoJsonDataSource();
 $("input[id='Imperial_Russia_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			        Imperial_Russia.load('./json/Kotkin_Imperial_Russia.geojson',
					{
					 stroke: Cesium.Color.GRAY,
					fill: Cesium.Color.LIGHTSTEELBLUE.withAlpha(0.6),
						});
...
var Wild_East= new Cesium.GeoJsonDataSource();
 $("input[id='Wild_East_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Wild_East.load('./json/Kotkin_Wild_East.geojson',
					{
					 stroke: Cesium.Color.GRAY,
					fill: Cesium.Color.KHAKI.withAlpha(0.6),
						});
...
var Iranistan= new Cesium.GeoJsonDataSource();
 $("input[id='Iranistan_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Iranistan.load('./json/Kotkin_Iranistan.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Greater_Arabia= new Cesium.GeoJsonDataSource();
 $("input[id='Greater_Arabia_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Greater_Arabia.load('./json/Kotkin_Greater_Arabia.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Ottoman_Empire= new Cesium.GeoJsonDataSource();
 $("input[id='Ottoman_Empire_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Ottoman_Empire.load('./json/Kotkin_Ottoman_Empire.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Rubber_Belt= new Cesium.GeoJsonDataSource();
 $("input[id='Rubber_Belt_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 Rubber_Belt.load('./json/Kotkin_Rubber_Belt.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var Stand_Alones= new Cesium.GeoJsonDataSource();
 $("input[id='Stand_Alones_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			        Stand_Alones.load('./json/Kotkin_Stand_Alones.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var western= new Cesium.GeoJsonDataSource();
 $("input[id='western_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 western.load('./json/Huntington_western.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var sinic= new Cesium.GeoJsonDataSource();
 $("input[id='sinic_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 sinic.load('./json/Huntington_sinic.geojson',
					{
					 stroke: Cesium.Color.GRAY,
					fill: Cesium.Color.RED.withAlpha(0.6),
						});
			...
			viewer.clock.shouldAnimate = false;
			//控制图例
			document.getElementById('legendbox').src = "img/enHengTDlegend.jpg";
			document.getElementById('mylegend').style.display = 'block';
					}
					else
					{ 
...
var islanmic= new Cesium.GeoJsonDataSource();
 $("input[id='islanmic_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
			 islanmic.load('./json/Huntington_islanmic.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var orthodox = new Cesium.GeoJsonDataSource();
 $("input[id='orthodox_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
					 orthodox .load('./json/Huntington_orthodox.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var buddhist= new Cesium.GeoJsonDataSource();
 $("input[id='buddhist_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
					buddhist.load('./json/Huntington_buddhist.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var hindu= new Cesium.GeoJsonDataSource();
 $("input[id='hindu_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{
					hindu.load('./json/Huntington_hindu.geojson',
					{
					 stroke: Cesium.Color.GRAY,
...
var GDP_data= new Cesium.KmlDataSource();
 $("input[id='GDP_checkbox']").click(function(){
					...
					{//当点击了checkbox之后，checkbox先变成了'checked'，才执行下面的代码
                         document.getElementById('mylegend').style.display = 'none';
						GDP_data.load('./kml/gdpPerCapita_2008.kmz');
...
$("li[id='GDPcontrol']>a").toggle(
 ...
 var POP_data= new Cesium.KmlDataSource();
  $("input[id='POP_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{//当点击了checkbox之后，checkbox先变成了'checked'，才执行下面的代码
					 POP_data.load('./kml/pop.kml');
                      viewer.dataSources.add(POP_data);
					  viewer.clock.shouldAnimate = false;
					  document.getElementById('legendbox').src = "img/enpop.jpg";
                      document.getElementById('mylegend').style.display = 'block'; 
					}
					else
					{ 
                    if( $(".contro").not("#POP_checkbox").attr("checked")==false){
					document.getElementById('mylegend').style.display = 'none';
...
font : '11pt monospace',
 ...
 verticalOrigin : Cesium.VerticalOrigin.BOTTOM,
					...
					viewer.clock.shouldAnimate = false;
                    document.getElementById('legendbox').src = "img/enAIIB.jpg";
			        document.getElementById('mylegend').style.display = 'block';
					}
					else
					{ 
                        ...
                        if( $(".aiib").not("#AIIB_checkbox").attr("checked")==false){
                        document.getElementById('mylegend').style.display = 'none';
                        }
					}
 ...
 verticalOrigin : Cesium.VerticalOrigin.BOTTOM,
					...
					{ 
						...
						viewer.entities.removeById(AIIB02[index]);
                         ...
                         if( $(".aiib").not("#non_AIIB_checkbox").attr("checked")==false){
                        document.getElementById('mylegend').style.display = 'none'; 
                        }                        
					}
...
var obor_anti_Terrorism= new Cesium.KmlDataSource();
 $("input[id='anti_Terrorism01_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{//当点击了checkbox之后，checkbox先变成了'checked'，才执行下面的代码
					obor_anti_Terrorism.load('./kml/anti_Terrorism01.kml');
					viewer.dataSources.add(obor_anti_Terrorism);
					viewer.clock.shouldAnimate = false;
					//控制图例
					  document.getElementById('legendbox').src = "img/enTerrorismRisk.jpg";
                      document.getElementById('mylegend').style.display = 'block'; 
                    ...
                    if( $(".anti").not("#anti_Terrorism01_checkbox").attr("checked")==false){
					    document.getElementById('mylegend').style.display = 'none';	
                     }                        
					}
...
var other_anti_Terrorism= new Cesium.KmlDataSource();
 $("input[id='anti_Terrorism02_checkbox']").click(function(){
					...
					if($(this).attr('checked')==true)
					{//当点击了checkbox之后，checkbox先变成了'checked'，才执行下面的代码
					other_anti_Terrorism.load('./kml/anti_Terrorism02.kml');
                    ...
                    if( $(".anti").not("#anti_Terrorism02_checkbox").attr("checked")==false){
					document.getElementById('mylegend').style.display = 'none';
                    }
					}
                        ...
                        //$(".cesium-infoBox-description").css("margin-right","0px");
                         ...
                         point[t]=new Cesium.Entity({
                                        ...
                                        description: '<div >\
                                            ...
                                            <source src="./img/webcam_sample.webm" type="video/webm">\
                                            </source>\
                                            </div>\
                                            </video>',
                                        billboard:{
                                            image:'./img/mycamera.png',
                                            scale:0.2,
...
(function(){
    ...
    myWidget=new myWidget(viewer,scene,ellipsoid);//此类在MyWidget文件中声明
    ...
    layers.add(imageLabelEn);//默认是英文注记
    ...
    for(var i=0;i<7;i++){
        ...
        conta.eq(j).click(function(){
            switch(j){
                ...
                case 6:
                     if($(this).attr('checked')==true){
                        document.getElementById('legendbox').src = "img/global30.png";
			            document.getElementById('mylegend').style.display = 'block';
...
//创建导航菜单
    function menu(){
        ...
        sdiv.css({position:"absolute",left:"5px",top:"5px"});
        //在js中写html代码
        var shtml= ''+
             '<ul>'+
                 '<li><a href="#">Display Shape</a>'+
                    '<ul>'+
                        '<li><a class="displayform" href="#">Shape Rectangle</a></li>'+
                        '<li><a class="displayform" href="#">Shape Wall</a></li>'+
                        '<li><a class="displayform" href="#">Shape Sphere</a></li>'+
                        '<li><a class="displayform" href="#">Shape Box</a></li>'+
                    '</ul>'+
                '</li>'+
                '<li><a href="#">Play Control</a>'+
                    '<ul>'+
                        '<li><a class="playcontrol" href="#">Play</a></li> '+
                        '<li><a class="playcontrol" href="#">Pause</a></li> '+
  ...
  //函数enfalserem，删除所有值为false的项目中所有的实体
    ...
    function menucontrol(){ 
        ...
        var itempath= new Array(4);
         itempath[0]='./img/webcam_sample.webm';
         itempath[1]='./img/webcam_sample.webm';
         itempath[2]='./img/webcam_sample.webm';
         itempath[3]='./img/webcam_sample.webm';        
   ...
   $(".imarea>ul>li>a").each(function(){
    ...
    (function(){
        ...
        //定义飞到的位置
        var flypo=[];
        flypo[0]=new Cesium.Cartesian3.fromDegrees(24.52344, 45.347852, 5000000);flypo[1]=new Cesium.Cartesian3.fromDegrees(46.789378,21.412996, 7000000);
        flypo[2]=new Cesium.Cartesian3.fromDegrees(64.993633, 42.495913, 5000000);flypo[3]=new Cesium.Cartesian3.fromDegrees(79.045977, 18.011586, 7000000);
        flypo[4]=new Cesium.Cartesian3.fromDegrees(109.737737, 32.271913, 7000000);flypo[5]=new Cesium.Cartesian3.fromDegrees(113.411740, 1.698890, 7000000);
        flypo[6]=new Cesium.Cartesian3.fromDegrees(43.52344, 46.347852, 7000000);
        //定义kml文件的路径
        var kmlpath=[];
        kmlpath[0]='./kml/ceeurope.kml';kmlpath[1]='./kml/WestAsia.kml';kmlpath[2]='./kml/CentralAsia.kml';kmlpath[3]='./kml/SouthAsia.kml';
        kmlpath[4]='./kml/EasternAsia.kml';kmlpath[5]='./kml/ASEAN.kml';kmlpath[6]='./kml/cis.kml';
        ...
        for(var i=0;i<7;i++){
            (function(j){
                ...
                $(".areashow").eq(j).click(
                function(){
                   if($(this).attr('checked')==true){//注意！在判断checked，disabled这些二元值属性时，只能用prop，它与attr的区别详看书上或者网上
                        var t = imarea[j].load(kmlpath[j]);
                         viewer.dataSources.add(t); 
                    }
                   else{
                        viewer.dataSources.remove(imarea[j]);
                        console.log('ww');//删除必须是datasource对象
                    }
                }); 
            })(i);
        }    
        for(var i=0;i<7;i++){
            (function(j){
                 $(".ashow>a").eq(j).click(
                        function(){
                        console.log('bb');
                            if($(this).parent().children().attr("checked")==false){
                                $(this).parent().children().attr("checked","true");
                                var t = imarea[j].load(kmlpath[j]);
                                viewer.dataSources.add(t); 
                                 console.log('tt');
                            }
...
function socialde(){
    ...
    function updateLineData() {
        ...
        for (var i=0; i<polylines.length; i++) {
            ...
            if (selectedData === "health") {
              ...
              //polyline.cylinder.length=yScale(nation.lifeExpectancy);
                //console.log('enen');
            } else {
                polyline.positions = ellipsoid.cartographicArrayToCartesianArray([
                            Cesium.Cartographic.fromDegrees(nation.lon, nation.lat, 0.0),
                ...
                //polyline.cylinder.length=xScale(nation.income);

            }
            polyline.width = widthScale(nation.population);
           // polyline.cylinder.bottomRadius=widthScale(nation.population);
           // polyline.cylinder.topRadius =widthScale(nation.population);
            ...
            if (nation.name === selectedNation) {
                ...
                $("#info").append("<table> \
                <tr><td>Life Expetancy:</td><td>" +parseFloat(nation.lifeExpectancy).toFixed(1)+"</td></tr>\
                <tr><td>Per Capita GDP:</td><td>" +parseFloat(nation.income).toFixed(0)+"</td></td></tr>\
                <tr><td>Population:</td><td>" +parseFloat(nation.population).toFixed(0)+"</td></tr>\
                </table>\ ");
                $("#info").append("<div>\
                 <img class=\"close\" src=\"img/close.png\" style=\"width:25px;height:25px;position:absolute;right:5px;top:3px;z-index:10001;cursor:pointer\"></div>");
    ...
    sharedObject.dispatch.on("nationMouseover.cesium", function(nationObject) {
            for (var i=0; i<polylines.length; i++) {
                ...
                if (polyline.nationData.name === nationObject.name) {
                    //polyline.cylinder.material.uniforms.color= Cesium.Color.fromCssColorString('#00ff00');
                    polyline.material.uniforms.color = Cesium.Color.fromCssColorString('#00ff00');
                }
                else {
                   // polyline.cylinder.material.uniforms.color= Cesium.Color.fromCssColorString(colorScale(polyline.nationData.region));
    ...
    function time(){
     ...
     // Load the data.
   //var polylineCollection = new Cesium.CustomDataSource();
    var polylineCollection = new Cesium.PolylineCollection();
    function dataload(){
        d3.json("./json/nations_geo.json", function(nations) {
           var ellipsoid = viewer.scene.globe.ellipsoid;
            ...
            for (var i = 0; i < nations.length; i++){
             ...
             /*   var widePolyline = new Cesium.Entity();
                widePolyline.position = Cesium.Cartesian3.fromDegrees(nation.lon, nation.lat);
                widePolyline.cylinder= new Cesium.CylinderGraphics({
                   // length : 100000,
                    //topRadius : 100000.0,
                ...
                widePolyline.cylinder.length=100000;
                widePolyline.cylinder.topRadius=100000;
                widePolyline.cylinder.bottomRadius=100000;
                polylineCollection.entities.add(widePolyline);

                // Set a polyline's width
               // var outlineMaterial = Cesium.Material.fromType('Color');
               // outlineMaterial.uniforms.outlineWidth = 3.0;
               // outlineMaterial.uniforms.outlineColor = new Cesium.Color(0.0, 0.0, 0.0, 1.0);
               //outlineMaterial.uniforms.color = Cesium.Color.GREEN.withAlpha(1.0);//Cesium.Color.fromCssColorString(colorScale(nation.region));//颜色设置为css方式的颜色值,具体颜色用d3中的colorScale来构造
              //  widePolyline.cylinder.material = outlineMaterial;*/
           ...
           //viewer.dataSources.add(polylineCollection);//在视图中加载polylineCollection
