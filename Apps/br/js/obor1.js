 ...
 //将 BingMapsApi.defaultKey对象设置为自己申请的BingApiKey
    ...
    imageryViewModels.push(new Cesium.ProviderViewModel({
            ...
            creationFunction : function() {
                return new Cesium.ArcGisMapServerImageryProvider({
                    url : 'http://180.168.169.146:6080/arcgis/rest/services/云南影像2/MapServer',
  ...
  imageryViewModels.push(new Cesium.ProviderViewModel({
            ...
            creationFunction : function() {
                return new Cesium.ArcGisMapServerImageryProvider({
                    url : 'http://180.168.169.146:6080/arcgis/rest/services/云南边界2/MapServer',
                    enablePickFeatures : false
                });
            }
        }));
    imageryViewModels.push(new Cesium.ProviderViewModel({
            ...
            creationFunction : function() {
                return new Cesium.ArcGisMapServerImageryProvider({
                    url : 'http://180.168.169.146:6080/arcgis/rest/services/云南县界2/MapServer',
                    enablePickFeatures : false
                });
            }
        }));    
 ...
 imageryViewModels.push(new Cesium.ProviderViewModel({
            ...
            tooltip : '全球夜间灯光: The lights of cities and villages trace the outlines of civilization in this global view of the \
...
$("#general_route>a").toggle( 
				function(){
					...
					viewer.dataSources.add(Cesium.KmlDataSource.load('./kml/recountry.kml'));
					document.getElementById('legendbox').src = "img/route.jpg";
...
var Relations_china= new Cesium.GeoJsonDataSource();
 $("input[id='Relations_china_radio']").click(function(){
	...
	viewer.entities.add(Iran_flag);
			//控制图例
			document.getElementById('legendbox').src = "img/Relations.jpg";
			document.getElementById('mylegend').style.display = 'block';
...
$("li[id=Nation_status]>a").toggle( 
			 ...
			 promise.then(function(dataSource)
				...
				for(var i=0;i<json_entities.length;i++)
					...
					//控制图例
					document.getElementById('legendbox').src = "img/nation_status.jpg";
					document.getElementById('mylegend').style.display = 'block';
...
$("li[id=Kotkin_cival]>a").toggle( 
			 ...
			 promise.then(function(dataSource)
				...
				for(var i=0;i<json_entities.length;i++)
					...
					//控制图例
					document.getElementById('legendbox').src = "img/KTJ.jpg";
					document.getElementById('mylegend').style.display = 'block';
...
var sinic= new Cesium.GeoJsonDataSource();
 $("input[id='sinic_checkbox']").click(function(){
			...
			viewer.clock.shouldAnimate = false;
			//控制图例
			document.getElementById('legendbox').src = "img/HengTDlegend.jpg";
			document.getElementById('mylegend').style.display = 'block';
					}
					else
					{ 
  ...
  $("input[id='POP_checkbox']").click(function(){
					...
					{//当点击了checkbox之后，checkbox先变成了'checked'，才执行下面的代码
					 POP_data.load('./kml/pop.kml');
					  ...
					  viewer.clock.shouldAnimate = false;
					  document.getElementById('legendbox').src = "img/pop.jpg";
                      document.getElementById('mylegend').style.display = 'block'; 
					}
					else
					{ 
...
font : '11pt monospace',
 ...
 verticalOrigin : Cesium.VerticalOrigin.BOTTOM,
					...
					viewer.clock.shouldAnimate = false;
                    document.getElementById('legendbox').src = "img/AIIB.jpg";
			        document.getElementById('mylegend').style.display = 'block';
					}
					else
					{ 
...
var obor_anti_Terrorism= new Cesium.KmlDataSource();
 $("input[id='anti_Terrorism01_checkbox']").click(function(){
					...
					viewer.clock.shouldAnimate = false;
					//控制图例
					  document.getElementById('legendbox').src = "img/TerrorismRisk.jpg";
                      document.getElementById('mylegend').style.display = 'block'; 
